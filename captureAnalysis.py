...
def intensity_graph(filename='output.avi'):
    ...
    # weights = np.array([[0.0025, 0.004 , 0.006 , 0.0075, 0.01  , 0.0075, 0.006 , 0.004 , 0.0025],
    #                     [0.004 , 0.0064, 0.0096, 0.012 , 0.016 , 0.012 , 0.0096, 0.0064, 0.004 ],
    #                     [0.006 , 0.0096, 0.0144, 0.018 , 0.024 , 0.018 , 0.0144, 0.0096, 0.006 ], 
    #                     [0.0075, 0.012 , 0.018 , 0.0225, 0.03  , 0.0225, 0.018 , 0.012 , 0.0075],
    #                     [0.01  , 0.016 , 0.024 , 0.03  , 0.04  , 0.03  , 0.024 , 0.016 , 0.01  ],
    #                     [0.0075, 0.012 , 0.018 , 0.0225, 0.03  , 0.0225, 0.018 , 0.012 , 0.0075],
    #                     [0.006 , 0.0096, 0.0144, 0.018 , 0.024 , 0.018 , 0.0144, 0.0096, 0.006 ],
    #                     [0.004 , 0.0064, 0.0096, 0.012 , 0.016 , 0.012 , 0.0096, 0.0064, 0.004 ],
    #                     [0.0025, 0.004 , 0.006 , 0.0075, 0.01  , 0.0075, 0.006 , 0.004 , 0.0025]])
    ...
    while cap.isOpened():
        ...
        for k in range(len(pxArray)):
            ...
            # intensityArray[k].append(frame[y,x])
